...
# ╔═╡ a5d8273c-5e99-11ed-227c-2d1b10f5ec9f
using Plots

# ╔═╡ eaf46f79-a082-4371-8015-3670c80e5846
md"""
# Some notes

What is the difference between function and method?

1. I will tell you later.
2. A lot.
"""

# ╔═╡ 6eb90cd0-7c3f-42bb-bcfe-25aa268fb6d2
function forecast_AR(ρ, y0, T)
	y = ones(T)
	y[1] = y0
	for t = 2:T
		y[t] = ρ * y[t-1]
...
# ╔═╡ 489d283d-3292-4cbf-8801-cced79e1cea8
md"Keep $\rho=...$ here to illustrate that it is not available outside function scope."

# ╔═╡ 1d711c3b-1852-46c7-a449-8feeadd7a8e1
ρ

# ╔═╡ d9c8b4d8-b6b4-4b64-9095-3de7683f7992
z = forecast_AR(1.0, 1.0, 30)

# ╔═╡ 8ccd5880-d73c-4e22-a844-120c2e9e208d
plot(z)

# ╔═╡ 4adc3e8e-cc1d-4b1f-8814-edba4549d2de
function forecast_AR2(a1, a2, y0, y1, T=30)
	y = ones(T)
	y[1] = y0
	y[2] = y1
	for t = 3:T
...
# ╔═╡ 98566d9c-eb52-472d-80ca-24014d036432
a2 = 0.6

# ╔═╡ 54897c6a-a9d8-4426-a763-d220c6bc7750
plot(forecast_AR2(-0.1, a2, 1.0, 1.0, 30))

# ╔═╡ 10a12d9a-9ab9-410a-ac17-661f76e886e4
md"""
## Assignments
...
$y_t - \frac {b}{1-a} = a\left[y_{t-1} - \frac b{1-a}\right]$
...
$a_1 y_{t-1} + a_2 y_{t-2} = a_1 L y_t + a_2 L(L y_t) = a_1 L y_t + a_2 L^2 y_t$
